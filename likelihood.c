...
int SetProteinQMatrix (MrBFlt **a, int n, int whichChain, int division, MrBFlt rateMult)
{
    ...
    if (n == 20)
        ...
        if (aaModelID == AAMODEL_POISSON)
        ...
        else if (aaModelID == AAMODEL_MTART)
            {
            for (i=0; i<20; i++)
                for (j=0; j<20; j++)
                    a[i][j] = aaMtart[i][j];
            }
        else if (aaModelID == AAMODEL_MTZOA)
            {
            for (i=0; i<20; i++)
                for (j=0; j<20; j++)
                    a[i][j] = aaMtzoa[i][j];
            }
        else if (aaModelID == AAMODEL_PMB)
            {
            for (i=0; i<20; i++)
                for (j=0; j<20; j++)
                    a[i][j] = aaPmb[i][j];
            }
        else if (aaModelID == AAMODEL_HIVB)
            {
            for (i=0; i<20; i++)
                for (j=0; j<20; j++)
                    a[i][j] = aaHivb[i][j];
            }
        else if (aaModelID == AAMODEL_HIVW)
            {
            for (i=0; i<20; i++)
                for (j=0; j<20; j++)
                    a[i][j] = aaHivw[i][j];
            }
        else if (aaModelID == AAMODEL_FLU)
            {
            for (i=0; i<20; i++)
                for (j=0; j<20; j++)
                    a[i][j] = aaFlu[i][j];
            }
        else if (aaModelID == AAMODEL_STMTREV)
            {
            for (i=0; i<20; i++)
                for (j=0; j<20; j++)
                    a[i][j] = aaStmtrev[i][j];
        ...
        else if (aaModelID == AAMODEL_JONESF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaJonesF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaJonesF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_DAYF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaDayhoffF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaDayhoffF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_MTREVF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaMtrev24F[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaMtrev24F[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_MTMAMF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaMtmamF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaMtmamF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_RTREVF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aartREVF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aartREVF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_WAGF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaWAGF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaWAGF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_CPREVF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aacpREVF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aacpREVF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaVtF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaVtF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_BLOSUMF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaBlosumF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaBlosumF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaLGF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaLGF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_MTARTF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaMtartF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaMtartF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_MTZOAF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaMtzoaF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaMtzoaF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_PMBF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaPmbF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaPmbF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_HIVBF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaHivbF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaHivbF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_HIVWF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaHivwF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaHivwF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_FLUF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaFluF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaFluF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        else if (aaModelID == AAMODEL_STMTREVF)
            {
            bs = GetParamSubVals (m->stateFreq, whichChain, state[whichChain]);
            for (i = 0; i < 20; i++)
                for (j = 0; j < 20; j++)
            ...
            for (i = 0; i < 20; i++) {
                for (j = i + 1; j < 20; j++) {
                    a[i][i] -= (a[i][j] = bs[j] * aaStmtrevF[i][j]);
                    a[j][j] -= (a[j][i] = bs[i] * aaStmtrevF[j][i]);
                }
            }
            for (i = 0; i < 20; i++)
                scaler += -(bs[i] * a[i][i]);
        ...
        if (aaModelID == AAMODEL_POISSON)
            ...
            for (i=0; i<20; i++)
                ...
                for (j=i+1; j<20; j++)
                    ...
                    a[i][j] = aaMtart[i][j];
                    a[j][i] = aaMtart[j][i];
                    scaler += mtartPi[i] * a[i][j] * probOn;
                    scaler += mtartPi[j] * a[j][i] * probOn;
                    }
                }
            }
        else if (aaModelID == AAMODEL_MTZOA)
            ...
            for (i=0; i<20; i++)
                ...
                for (j=i+1; j<20; j++)
                    ...
                    a[i][j] = aaMtzoa[i][j];
                    a[j][i] = aaMtzoa[j][i];
                    scaler += mtzoaPi[i] * a[i][j] * probOn;
                    scaler += mtzoaPi[j] * a[j][i] * probOn;
                    }
                }
            }
        else if (aaModelID == AAMODEL_PMB)
            ...
            for (i=0; i<20; i++)
                ...
                for (j=i+1; j<20; j++)
                    ...
                    a[i][j] = aaPmb[i][j];
                    a[j][i] = aaPmb[j][i];
                    scaler += pmbPi[i] * a[i][j] * probOn;
                    scaler += pmbPi[j] * a[j][i] * probOn;
                    }
                }
            }
        else if (aaModelID == AAMODEL_HIVB)
            ...
            for (i=0; i<20; i++)
                ...
                for (j=i+1; j<20; j++)
                    ...
                    a[i][j] = aaHivb[i][j];
                    a[j][i] = aaHivb[j][i];
                    scaler += hivbPi[i] * a[i][j] * probOn;
                    scaler += hivbPi[j] * a[j][i] * probOn;
                    }
                }
            }
        else if (aaModelID == AAMODEL_HIVW)
            ...
            for (i=0; i<20; i++)
                ...
                for (j=i+1; j<20; j++)
                    ...
                    a[i][j] = aaHivw[i][j];
                    a[j][i] = aaHivw[j][i];
                    scaler += hivwPi[i] * a[i][j] * probOn;
                    scaler += hivwPi[j] * a[j][i] * probOn;
                    }
                }
            }
        else if (aaModelID == AAMODEL_FLU)
            ...
            for (i=0; i<20; i++)
                ...
                for (j=i+1; j<20; j++)
                    ...
                    a[i][j] = aaFlu[i][j];
                    a[j][i] = aaFlu[j][i];
                    scaler += fluPi[i] * a[i][j] * probOn;
                    scaler += fluPi[j] * a[j][i] * probOn;
                    }
                }
            }
        else if (aaModelID == AAMODEL_STMTREV)
            ...
            for (i=0; i<20; i++)
                ...
                for (j=i+1; j<20; j++)
                    ...
                    a[i][j] = aaStmtrev[i][j];
                    a[j][i] = aaStmtrev[j][i];
                    scaler += stmtrevPi[i] * a[i][j] * probOn;
                    scaler += stmtrevPi[j] * a[j][i] * probOn;
                    }
                }
            }
