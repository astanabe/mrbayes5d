...
void SetUpParms (void)
{
    ...
    PARAM  (30, "Aamodel",        DoLsetParm,        "Poisson|Equalin|Jones|Dayhoff|Mtrev|Mtmam|Wag|Rtrev|Cprev|Vt|Blosum|Blossum|LG|Mtart|Mtzoa|Pmb|Hivb|Hivw|Flu|Stmtrev|JonesF|DayhoffF|MtrevF|MtmamF|WagF|RtrevF|CprevF|VtF|BlosumF|LGF|MtartF|MtzoaF|PmbF|HivbF|HivwF|FluF|StmtrevF\0");
