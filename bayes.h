...
#define AAMODEL_MTART           11
#define AAMODEL_MTZOA           12
#define AAMODEL_PMB             13
#define AAMODEL_HIVB            14
#define AAMODEL_HIVW            15
#define AAMODEL_FLU             16
#define AAMODEL_STMTREV         17

#define AAMODEL_JONESF          18
#define AAMODEL_DAYF            19
#define AAMODEL_MTREVF          20
#define AAMODEL_MTMAMF          21
#define AAMODEL_WAGF            22
#define AAMODEL_RTREVF          23
#define AAMODEL_CPREVF          24
#define AAMODEL_VTF             25
#define AAMODEL_BLOSUMF         26
#define AAMODEL_LGF             27
#define AAMODEL_MTARTF          28
#define AAMODEL_MTZOAF          29
#define AAMODEL_PMBF            30
#define AAMODEL_HIVBF           31
#define AAMODEL_HIVWF           32
#define AAMODEL_FLUF            33
#define AAMODEL_STMTREVF        34

#define AAMODEL_EQ              35
#define AAMODEL_GTR             36 /* aa models with free parameters must be listed last */
...
extern MrBFlt           aaMtart[20][20];             /* rates for mtArt model                        */
extern MrBFlt           aaMtzoa[20][20];             /* rates for mtZoa model                        */
extern MrBFlt           aaPmb[20][20];               /* rates for PMB model                          */
extern MrBFlt           aaHivb[20][20];              /* rates for HIVb model                         */
extern MrBFlt           aaHivw[20][20];              /* rates for HIVw model                         */
extern MrBFlt           aaFlu[20][20];               /* rates for FLU model                          */
extern MrBFlt           aaStmtrev[20][20];           /* rates for stmtREV model                      */

extern MrBFlt           aaJonesF[20][20];            /* rates for Jones+F model                      */
extern MrBFlt           aaDayhoffF[20][20];          /* rates for Dayhoff+F model                    */
extern MrBFlt           aaMtrev24F[20][20];          /* rates for mtrev24+F model                    */
extern MrBFlt           aaMtmamF[20][20];            /* rates for mtmam+F model                      */
extern MrBFlt           aartREVF[20][20];            /* rates for rtREV+F model                      */
extern MrBFlt           aaWAGF[20][20];              /* rates for WAG+F model                        */
extern MrBFlt           aacpREVF[20][20];            /* rates for aacpREV+F model                    */
extern MrBFlt           aaVtF[20][20];               /* rates for VT+F model                         */
extern MrBFlt           aaBlosumF[20][20];           /* rates for Blosum62+F model                   */
extern MrBFlt           aaLGF[20][20];               /* rates for LG+F model                         */
extern MrBFlt           aaMtartF[20][20];            /* rates for mtArt+F model                      */
extern MrBFlt           aaMtzoaF[20][20];            /* rates for mtZoa+F model                      */
extern MrBFlt           aaPmbF[20][20];              /* rates for PMB+F model                        */
extern MrBFlt           aaHivbF[20][20];             /* rates for HIVb+F model                       */
extern MrBFlt           aaHivwF[20][20];             /* rates for HIVw+F model                       */
extern MrBFlt           aaFluF[20][20];              /* rates for FLU+F model                        */
extern MrBFlt           aaStmtrevF[20][20];          /* rates for stmtREV+F model                    */
...
extern MrBFlt           mtartPi[20];                 /* stationary frequencies for mtArt model       */
extern MrBFlt           mtzoaPi[20];                 /* stationary frequencies for mtZoa model       */
extern MrBFlt           pmbPi[20];                   /* stationary frequencies for PMB model         */
extern MrBFlt           hivbPi[20];                  /* stationary frequencies for HIVb model        */
extern MrBFlt           hivwPi[20];                  /* stationary frequencies for HIVw model        */
extern MrBFlt           fluPi[20];                   /* stationary frequencies for FLU model         */
extern MrBFlt           stmtrevPi[20];               /* stationary frequencies for stmtREV model     */
